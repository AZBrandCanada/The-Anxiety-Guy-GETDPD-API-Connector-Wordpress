...
- `current_page.txt`: this is a setting file for 2.3wordpress.py, set it before running to the desired page you want to start indexing from the API. setting 1 will index all pages up to the current date. 
